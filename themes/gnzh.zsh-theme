...
local jenv_java='%{$PR_RED%}jdk-$(java -version 2>&1 | grep "java version" | sed -e "s/java version //" | sed -e "s/\"//g")%{$PR_NO_COLOR%}'

#PROMPT="${user_host} ${current_dir} ${rvm_ruby} ${git_branch}$PR_PROMPT "
#PROMPT="╭─${user_host} ${current_dir} ${rvm_ruby} ${git_branch}
PROMPT="${user_host} ${current_dir} ${git_branch} ${jenv_java}
$PR_PROMPT"
#╰─$PR_PROMPT"
